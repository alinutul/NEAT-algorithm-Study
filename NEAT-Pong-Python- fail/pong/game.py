...
import pygame
import random
# REMOVE THE PYGAME INITIALIZATION FROM HERE
# The main script will handle initialization and quitting.
...
class Game:
    ...
    def __init__(self, window, window_width, window_height):
        # The font object is now created safely after the font module is initialized
