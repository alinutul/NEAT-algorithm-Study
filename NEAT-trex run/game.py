...
class Obstacle:
    def __init__(self,image,number_of_cact):
        self.image = image
        self.type = number_of_cact
...
class SmallCactus(Obstacle):
    def __init__(self,image, number_of_cact):
        super().__init__(image, number_of_cact)
        self.rect.y = 325
...
def eval_genomes(genomes,config):
    ...
    def stats():
        ...
        text1 = FONT.render(f'Dinosaurs Alive: {str(len(dinosaurs))}',True,(0,0,0))
        text2 = FONT.render(f'Generation: {pop.generation+1}',True,(0,0,0))
        text3 = FONT.render(f'Speed: {str(game_speed)}',True,(0,0,0))
